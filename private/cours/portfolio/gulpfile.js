...
const purgecss = require("gulp-purgecss"); // purge css
/*

COMMANDE DE MISE EN PLACE DE GULP 
npm install
...
function watcherSass() {
  watch("css/**/*.scss", { ignoreInitial: false }, sass).on(
    "change",
    function () {
...
function watcherJsConcatMinif() {
  watch("./js/a_compresser/*.js", { ignoreInitial: false }, jsConcatMinif).on(
    "change",
    function () {
...
function watcherJsBabel() {
  watch("./js/**/*.es6.js", { ignoreInitial: false }, jsBabel).on(
    "change",
    function () {
